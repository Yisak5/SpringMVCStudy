				...
				<table class="table">
					...
					<tbody>
						...
						<!-- <tr>
							...
							<td>010-9999-9999</td>
							<td>
								<button type="button" class="btn btn-dafault btn-xs btnUpdate">수정</button>
								<button type="button" class="btn btn-dafault btn-xs btnDelete">삭제</button>
							</td>
						</tr> -->
						<c:forEach var="member" items="${list}">
							<tr>
								...
								<td>
									<button type="button" class="btn btn-dafault btn-xs btnUpdate"
									value="${member.mid }">수정</button>
									<button type="button" class="btn btn-dafault btn-xs btnDelete"
