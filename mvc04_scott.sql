...
INSERT INTO EMPLOYEE(EMPLOYEEID, NAME, SSN, BIRTHDAY, LUNAR
                     ...
                     , BASICPAY, EXTRAPAY)
VALUES(EMPLOYEESEQ.NEXTVAL, '김상기', CRYPTPACK.ENCRYPT('9410041234567', '9610041234567')
...
SELECT *
FROM EMPLOYEE;
--==>> 1	김상기	h7v??đ?[s	1996-10-04	0	010-5693-4223	1	2	1	2500000	1500000
...
--==>>
/*
1	김상기	h7v??đ?[s	1996-10-04	0	양력	010-5693-4223	1	개발부	2	대리	1	서울	2500000	1500000	4000000
*/
...
--  『경기』, 『인천』, 『대전』, 『광주』, 『대구』의 데이터는 삭제가 가능한 상태
...
SELECT *
FROM EMPLOYEE;
--==>> 1	김상기	h7v??đ?[s	1996-10-04	0	010-5693-4223	1	2	1	2500000	1500000	941004	=o???
...
SELECT *
FROM EMPLOYEE;
--==>> 1	김상기	1996-10-04	0	010-5693-4223	1	2	1	2500000	1500000	941004	=o???	1
...
SELECT *
FROM EMPLOYEE;
--==>> 1	김상기	1996-10-04	0	010-5693-4223	1	2	1	2500000	1500000	941004	=o???	0
...
--> 한 줄 구성
INSERT INTO EMPLOYEE( EMPLOYEEID, NAME, SSN1, SSN2, BIRTHDAY, LUNAR, TELEPHONE, DEPARTMENTID, POSITIONID, REGIONID, BASICPAY, EXTRAPAY ) VALUES( EMPLOYEESEQ.NEXTVAL, '이연주', '950816', CRYPTPACK.ENCRYPT('2234567' , '2234567'), TO_DATE('1995-08-16', 'YYYY-MM-DD'), 0, '010-4423-0463', 1, 1, 1, 15000000, 1500000)
;
--==>> 1 행 이(가) 삽입되었습니다.
...
/*
1	김상기	1996-10-04	0	010-5693-4223	1	2	1	2500000	    1500000	941004	=o???	0
2	이연주	1995-08-16	0	010-4423-0463	1	1	1	15000000	1500000	950816	Y{?7?	1
*/
...
--==>> 직위 기본급 조회 쿼리문
SELECT POSITIONID, MINBASICPAY FROM POSITIONVIEW WHERE POSITIONID=1 ORDER BY POSITIONID
;
